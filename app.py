...
lineaccesstoken = 'Y9/ulJnoka9lChdMd03yhxkSvWnSjEWtX2OW9NKcwat4cT3VWL7LxDFSjb0bcdiYLBvZPJ0ONSCZfH6Nat6x+M4OYrBBiEfQicmiXEfryV/SJBUiC1rd2/Q+DxpbIIxUTztPfnaL4zf0WfdBxAN3EgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            ...
            replyObj = TextSendMessage(text="ไม่ล่ะกินเเล้ว")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/b20167ec-342c-4360-9b52-6fd6ea826db9"
